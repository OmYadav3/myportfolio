...
const Skills = () => {
    ...
    const getLevelColor = (level) => {
        ...
        return colors[level] || "bg-gray-400 bg-gray-500/20 border-gray-500/30";
    };
    ...
    return (
        <section id="skills" className="relative py-20 bg-black overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden ">
                ...
                <div className="absolute bottom-1/2 right-0 w-96 h-96 bg-primary/10 rounded-full blur-3xl opacity-50"/>
            </div>
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <div className="flex item-center justify-between">
                                                            ...
                                                            <span
                                                                className={` text-xs px-2 py-2 rounded-full  border ${getLevelColor(skill.level)}`}
                                                            >
                                                                {skill.level}
                                                            </span>
                                                        </div>
