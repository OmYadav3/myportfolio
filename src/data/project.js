export const projects = [
    {
        ...
        image: "/images/projects/CareerHunting.png", // Add a demo screenshot here if you have one
        category: "Full Stack",
        technologies: ["React.Js", "Node.Js", "MongoDB", "TailwindCSS", "Shadcn", "Multer"],
        metrics:
    ...
    },
    {
        ...
        image: "/images/projects/Backend_image.webp", // Add a backend architecture diagram or API workflow image here
    ...
    },
    {
        ...
        image: "/images/projects/Fivepages.png", // Add a homepage or key UI screenshot here if available
        category: "Full Stack",
        technologies: [
            "Next.Js",
            "React.Js",
    ...
    },
    {
        ...
        image: "/images/projects/Recipe-page.jpg", // Add a screenshot of the recipe page UI
        ...
        demoUrl: "https://omyadav-recipe-page.netlify.app", // Optional: GitHub Pages link if deployed
        githubUrl:
    ...
    },
    {
        ...
        image: "/images/projects/ResumeBuilder.png", // Add a screenshot showing the resume editor or preview
        category: "Web Apps",
        technologies: ["React.Js", "Redux-toolkit", "TailwindCSS", "Responsive Design"],
        metrics:
...
export const categories = ['All', 'Web Apps', 'UI Components', 'Backend APIs', 'Full Stack'];
